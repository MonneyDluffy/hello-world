...
using BoardAutoTesting.Communication;
...
namespace Commons
{
    ...
    public class SerialPortUtil
    {
        ...
        void comPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            {
                Logger.Glog.Info("串口出问题了：" + exception.Message);
            }
        }
        ...
        public void WriteData(string msg)
        {
            ...
            {
                MessageRoute.SendFeedback(GlobalInt.ComPortError, 0, 0);
            }
        }
        ...
        public List<byte> Received_Data()
        {
            List<byte> _byteData = new List<byte>();
        ...
        public static void SetPortNameValues(ToolStripComboBox obj)
        {
            obj.Items.Clear();
            foreach (string str in SerialPort.GetPortNames())
            {
        ...
        public static void SetBauRateValues(ToolStripComboBox obj)
        {
            obj.Items.Clear();
            foreach (SerialPortBaudRates rate in Enum.GetValues(typeof(SerialPortBaudRates)))
            {
